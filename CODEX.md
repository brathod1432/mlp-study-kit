# CODEX.md — OpenAI Codex / ChatGPT Project Overview
...
Full theory, math, and codebase references are in `.openai/skills/`:

| Topic | File |
|-------|------|
| Activation functions (all 7 with derivatives) | `.openai/skills/activation-functions/SKILL.md` |
| Backpropagation (chain rule, delta chain, weight update) | `.openai/skills/backpropagation/SKILL.md` |
| Loss functions (MSE, BCE, metrics) | `.openai/skills/loss-functions/SKILL.md` |
| Training workflow (data prep, init, optimizers, API) | `.openai/skills/neural-network-training/SKILL.md` |
